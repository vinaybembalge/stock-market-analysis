...
### ✅ Notes:
- All chapter links are in valid `[text](link.md)` Markdown format.
- Mermaid diagrams are preserved properly for GitHub rendering.
- The `👉` arrow at the bottom gives readers a direct nudge to begin Chapter 1.

Let me know if you want:
- A sidebar-style layout with collapsible sections,
- A `Previous | Next` navigation at the bottom of each chapter,
- Or integration with Jupyter notebooks, badges, or CI workflows.
